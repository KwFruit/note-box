...
:::tip 表结构中插入的数据如下：
![](https://raw.gitmirror.com/KwFruit/basic-picture-service/note-v1.0.0/img/202408131418066.png)
:::

:::tip 数据准备好了之后，接下来，我们就来完成如下需求：
...
```
![](https://raw.gitmirror.com/KwFruit/basic-picture-service/note-v1.0.0/img/202408131422567.png)
:::
